...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12 mb-4 text-center">
            <h2 class="font-weight-bold text-info text-uppercase">Thêm bệnh nhân</h2>
        </div>
    </div>
    <!-- Content Row -->
    <!-- Form Add Document -->
            ...
            <div class="card shadow mb-4">
                ...
                <form action="#" method="POST" name="validate_form" onsubmit="return validate()">
                    ...
                    <div class="form-group row m-2">
                        <div class="col-sm-12">
                        <input type="text" class="form-control" name="username" id="username" placeholder="Nhập họ tên" value="" required>
                    ...
                    <div class="form-group row m-2">
                        <div class="col-sm-12">
                            <input type="date" class="form-control" name="birthday" id="birthday" placeholder="Chọn ngày sinh" required>
                    ...
                    <div class="form-group row m-2">
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="identitycard" id="identitycard" placeholder="Nhập số chứng minh nhân dân" required>
