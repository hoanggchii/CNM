                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xl-center font-weight-bold text-primary text-uppercase mb-1">
                                <a href="index.php?act=registe-calendar"> Quản lý lịch khám</a>
                            </div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xl-center font-weight-bold text-info text-uppercase mb-1">
                                <a href="index.php?act=list-patient">Quản lý bệnh nhân</a>
                            </div>
                        </div>
                        <div class="col-auto">
